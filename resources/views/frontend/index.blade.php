...
@section('content')
		...
		<div id="colorlib-featured-product">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<a href="product/shop" class="f-product-1" style="background-image: url(frontend/images/i1.jpg);">
								<div class="desc">
						...
						<div class="col-md-6">
							<div class="row">
								<div class="col-md-6">
									<a href="" class="f-product-2" style="background-image: url(frontend/images/i2.jpg);">
										<div class="desc">
											<h2> <br>Váy <br> Mới</h2>
										</div>
									</a>
								...
								<div class="col-md-6">
									<a href="" class="f-product-2" style="background-image: url(frontend/images/i3.jpg);">
										<div class="desc">
								...
								<div class="col-md-12">
									<a href="" class="f-product-2" style="background-image: url(frontend/images/i4.jpg);">
										<div class="desc">
			...
			<div id="colorlib-intro" class="colorlib-intro" style="background-image: url(frontend/images/banner-1.jpg);"
