						...
						<div class="col-md-4">
							...
							<table class="order-rable">
								<tbody>
									...
									<tr>
										<td>Ngày mua</td>
									<td>: {{ CarBon\Carbon::parse($order->created_at)->format('d-m-v') }}</td>
									</tr>
									<tr>
										<td>Tổng tiền</td>
								...
								<div class="order-wrapper mt-50">
									...
									<div class="order-list">
										...
										<div class="col-md-4">{{ $row->name }}</div>
												<div class="col-md-4" align='right'>{{ $row->quantity }}</div>
												<div class="col-md-4" align='right'>{{ number_format($row->quantity*$row->price,0,"",".") }}</div>
