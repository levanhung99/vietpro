        ...
        <div class="row">
            <div class="col-xs-6 col-md-12 col-lg-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">Sửa sản phẩm - {{$pro->name}} ({{$pro->code}})</div>
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <select name="category" class="form-control">
                                                  {{Getcategory($category,0,"",$pro->category_id)}}
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input  type="number" name="product_price" class="form-control"
                                                    value="{{$pro->price}}">
                                                    {!! showError($errors, 'product_price') !!}
                                            </div>
                                            <div class="form-group">
                                                <label>Sản phẩm nổi bật</label>
                                                <select  name="featured" class="form-control">
                                                    <option @if($pro->featured==0) selected @endif value="0">Không</option>                                           
                                                    <option @if($pro->featured==1) selected @endif value="1">Có</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Trạng thái</label>
                                                <select  name="product_state" class="form-control">
                                                    <option @if($pro->state==1) selected @endif  value="1">Còn hàng</option>
                                                    <option @if($pro->state==0) selected @endif value="0">Hết hàng</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                {!! showError($errors, 'product_img') !!}
                                                <input id="img" type="file" name="product_img" class="form-control hidden"
                                                    onchange="changeImg(this)">
                                                <img id="avatar" class="thumbnail" width="100%" height="350px" src="backend/img/{{$pro->img}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Thông tin</label>
                                    <textarea  name="info" style="width: 100%;height: 100px;"> {{$pro->info}}</textarea>
                                    </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Miêu tả</label>
                            <textarea id="editor"  name="description" style="width: 100%;height: 100px;">{{$pro->describe}}</textarea>
