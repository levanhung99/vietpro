									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a onclick="return Del_pro('{{$row->code}}')" href="/admin/product/del/{{$row->id}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
										</tr>
										@endforeach
									</tbody>
...
@parent
<script>
	function Del_pro(pro_code){
		return confirm('Bạn có muốn xóa sản phẩm có mã là: '+pro_code);
	}
</script>
